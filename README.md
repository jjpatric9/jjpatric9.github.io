...
| `demo.html` | Box Stack's playable ad, copied from `playable/index.html` in the Boxstack repository and loaded as `demo.html?host=web`. Re-copy it after the playable is rebuilt. |
